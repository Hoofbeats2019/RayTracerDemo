...
public:
	...
	glm::vec3 lighting(glm::vec3 lightPos, glm::vec3 lightColor, glm::vec3 viewVec, glm::vec3 hit);
	glm::vec3 lighting(glm::vec3 lightPos1, glm::vec3 lightPos2, glm::vec3 lightColor, glm::vec3 viewVec, glm::vec3 hit);
